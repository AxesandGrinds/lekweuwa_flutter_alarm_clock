...
import 'package:clock_alarm_app/bloc/alarm_bloc.dart';
import 'package:clock_alarm_app/models/alarm_info.dart';
...
class _AlarmState extends State<Alarm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: ThemeColors.pageBackgroundColor, //NeumorphicTheme.baseColor(context),
        ...
        child: StreamBuilder<List<AlarmInfo>>(
          ...
          builder: (context, snapshot) {
            ...
            ListView(
              ...
              child: Text(
                  "Add an alarm by clicking on + below",
                style: TextStyle(
                    fontFamily: 'avenir',
  ...
  Future<void> cancelScheduledAlarm(id, isCancelled) async {
    ...
    Scaffold.of(context).showSnackBar(
        ...
        SnackBar(
          ...
          content: Text(
            isCancelled ? "You Alarm has been Cancelled!" : "You Alarm has been Deleted!",
            style: TextStyle(
              color: Colors.white,
            ),
          ),
