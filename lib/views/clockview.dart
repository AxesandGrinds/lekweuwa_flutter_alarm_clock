...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var fillBrush = Paint()..color = ThemeColors.clockBG;
    var outlineBrush = Paint()
      ..color = ThemeColors.clockOutline
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width / 20;
    var centerDotBrush = Paint()..color = ThemeColors.clockOutline;

    var secHandBrush = Paint()
      ..color = ThemeColors.secHandColor
      ..style = PaintingStyle.stroke
    ...
    var minHandBrush = Paint()
      ..shader = RadialGradient(colors: [
        ThemeColors.minHandStatColor,
        ThemeColors.minHandEndColor
    ...
    var hourHandBrush = Paint()
      ..shader = RadialGradient(colors: [
        ThemeColors.hourHandStatColor,
        ThemeColors.hourHandEndColor
      ]).createShader(Rect.fromCircle(center: center, radius: radius))
      ..style = PaintingStyle.stroke
      ..strokeCap = StrokeCap.round
